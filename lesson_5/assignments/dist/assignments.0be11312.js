 ...
 */ async function initialLoad() {
    try {
        _uiJs.showLoading();
        (0, _utilsJs.log)('Fetching breeds...', 'info');
        const breeds = await _apiJs.fetchBreeds();
        _uiJs.populateBreedSelect(breeds);
        if (breeds.length) {
            const firstBreedId = breeds[0].id;
            _uiJs.setBreedSelectValue(firstBreedId);
            await loadBreedImages(firstBreedId);
        }
        (0, _utilsJs.log)(`Successfully loaded ${breeds.length} breeds`, 'success');
    } catch (error) {
        console.error("Failed to load breeds:", error);
        _uiJs.showError(`Failed to load breeds: ${error.message}`);
        (0, _utilsJs.log)(`Failed to load breeds: ${error.message}`, 'error');
    }
}
/**
 ...
 */ async function loadBreedImages(breedId) {
    try {
        _uiJs.showLoading();
        (0, _utilsJs.log)(`Loading images for breed ${breedId}...`, 'info');
        const images = await _apiJs.fetchBreedImages(breedId);
        const breed = images[0]?.breeds?.[0] || _apiJs.breedsCache.get(breedId);
        _uiJs.renderBreedInfo(breed);
        _uiJs.renderCarouselFromImages(images);
        (0, _utilsJs.log)(`Loaded ${images.length} images for ${breed?.name || 'breed'}`, 'success');
    } catch (error) {
        console.error("Failed to load breed images:", error);
        _uiJs.showError(`Failed to load breed images: ${error.message}`);
        (0, _utilsJs.log)(`Failed to load breed images: ${error.message}`, 'error');
    }
}
async function favourite(imgId) {
    try {
        (0, _utilsJs.log)(`Toggling favourite for image ${imgId}...`, 'info');
        const result = await _apiJs.toggleFavourite(imgId);
        if (result.action === "added") (0, _utilsJs.log)(`Added image ${imgId} to favourites`, 'success');
        else (0, _utilsJs.log)(`Removed image ${imgId} from favourites`, 'warning');
    } catch (error) {
        console.error("Failed to toggle favourite:", error);
        (0, _utilsJs.log)(`Failed to toggle favourite: ${error.message}`, 'error');
    }
}
/**
 ...
 */ async function getFavourites() {
    try {
        _uiJs.showLoading();
        (0, _utilsJs.log)('Loading favourites...', 'info');
        const favourites = await _apiJs.fetchFavourites();
        _carouselJs.clear();
        _uiJs.renderFavouritesInfo(favourites.length);
        favourites.forEach((favouriteItem)=>{
            if (!favouriteItem.image?.url) return;
            const item = _carouselJs.createCarouselItem(favouriteItem.image.url, "Favourite cat", favouriteItem.image_id);
            _carouselJs.appendCarousel(item);
        });
        if (favourites.length) _carouselJs.start();
        (0, _utilsJs.log)(`Loaded ${favourites.length} favourites`, 'success');
    } catch (error) {
        console.error("Failed to load favourites:", error);
        _uiJs.showError(`Failed to load favourites: ${error.message}`);
        (0, _utilsJs.log)(`Failed to load favourites: ${error.message}`, 'error');
    }
}
// ============= EVENT LISTENERS =============
...
breedSelect.addEventListener("change", async (event)=>{
    ...
    if (breedId) await loadBreedImages(breedId);
});
...
(0, _utilsJs.log)(' Cat API Browser initialized', 'success');

},{"./api.js":"jDkOf","./ui.js":"nQ04W","./Carousel.js":"kdhMV","./utils.js":"azjDB","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jDkOf":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "breedsCache", ()=>breedsCache);
/**
 ...
 */ parcelHelpers.export(exports, "fetchBreedImages", ()=>fetchBreedImages);
/**
 * Fetch all favourites
 * @returns {Promise<Array>} Array of favourite objects
 */ parcelHelpers.export(exports, "fetchFavourites", ()=>fetchFavourites);
/**
 * Toggle favourite status for an image
 * @param {string} imgId - The image ID
...
async function fetchBreeds() {
    const response = await (0, _axiosDefault.default).get("/breeds", {
        onDownloadProgress: (0, _utilsJs.updateProgress)
    });
    return response.data;
}
async function fetchBreedImages(breedId, limit = 10) {
    const response = await (0, _axiosDefault.default).get("/images/search", {
        params: {
            breed_ids: breedId,
            limit
        },
...
async function fetchFavourites() {
    const response = await (0, _axiosDefault.default).get("/favourites", {
        onDownloadProgress: (0, _utilsJs.updateProgress)
    });
    return response.data;
}
async function toggleFavourite(imgId) {
    const favourites = await fetchFavourites();
    const existingFavourite = favourites.find((item)=>item.image_id === imgId);
    if (existingFavourite) {
        await (0, _axiosDefault.default).delete(`/favourites/${existingFavourite.id}`);
        return {
            action: "removed",
            id: imgId
        };
    } else {
        await (0, _axiosDefault.default).post("/favourites", {
            image_id: imgId
        });
        return {
            action: "added",
...
},{"axios":"kooH4","./utils.js":"azjDB","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kooH4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./node/index.js":"1TZsR","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1TZsR":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utils.js":"jI6DP","./http.js":"dVGJ4","./xhr.js":"ao6fA","../core/AxiosError.js":"7z85x","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ao6fA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("./../utils.js");
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
...
},{"./AxiosError.js":"7z85x","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hoVvn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("./../utils.js");
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"d9uxL":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("./../utils.js");
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
...
},{"./../utils.js":"jI6DP","../platform/index.js":"626Zd","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"af3D4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cCdi6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
'use strict';
/**
...
},{"../utils.js":"jI6DP","./AxiosHeaders.js":"9EzTj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9wnyh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _dataJs = require("../env/data.js");
var _axiosErrorJs = require("../core/AxiosError.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"azjDB":[function(require,module,exports,__globalThis) {
// DOM Elements
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 ...
 */ parcelHelpers.export(exports, "updateProgress", ()=>updateProgress);
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"nQ04W":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * Populate the breed select dropdown
 * @param {Array} breeds - Array of breed objects
 */ parcelHelpers.export(exports, "populateBreedSelect", ()=>populateBreedSelect);
/**
 * Render breed information in the info dump section
 * @param {Object} breed - Breed object
 */ parcelHelpers.export(exports, "renderBreedInfo", ()=>renderBreedInfo);
/**
 * Render favourites information
 * @param {number} count - Number of favourites
 */ parcelHelpers.export(exports, "renderFavouritesInfo", ()=>renderFavouritesInfo);
/**
 * Render carousel from array of images
 * @param {Array} images - Array of image objects
 */ parcelHelpers.export(exports, "renderCarouselFromImages", ()=>renderCarouselFromImages);
/**
 * Set the breed select value
 * @param {string} breedId - The breed ID to select
 */ parcelHelpers.export(exports, "setBreedSelectValue", ()=>setBreedSelectValue);
/**
 * Get the currently selected breed ID
 * @returns {string} Selected breed ID
 */ parcelHelpers.export(exports, "getSelectedBreedId", ()=>getSelectedBreedId);
/**
...
function populateBreedSelect(breeds) {
    ...
    breeds.forEach((breed)=>{
        ...
        (0, _apiJs.breedsCache).set(breed.id, breed);
...
function renderFavouritesInfo(count) {
    infoDump.innerHTML = `
...
function renderCarouselFromImages(images) {
    _carouselJs.clear();
    images.forEach((image)=>{
        const breedName = image.breeds?.[0]?.name || "Cat";
        const item = _carouselJs.createCarouselItem(image.url, breedName, image.id);
        _carouselJs.appendCarousel(item);
    });
    if (images.length) _carouselJs.start();
}
function setBreedSelectValue(breedId) {
...
},{"./Carousel.js":"kdhMV","./api.js":"jDkOf","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kdhMV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"bootstrap":"hjCRY","./index.js":"NhzJs","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hjCRY":[function(require,module,exports,__globalThis) {
/*!
...
},{"./createPopper.js":"3NuA9","./modifiers/eventListeners.js":"b3l2h","./modifiers/popperOffsets.js":"iQIBA","./modifiers/computeStyles.js":"cU0Y8","./modifiers/applyStyles.js":"k3FfN","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["7oMV4","NhzJs"], "NhzJs", "parcelRequire6d5d", {})

//# sourceMappingURL=assignments.0be11312.js.map
