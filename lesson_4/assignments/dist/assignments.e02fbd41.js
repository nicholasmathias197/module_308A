...
})({"ltI17":[function(require,module,exports,__globalThis) {
...
function renderCarouselImages(images) {
    ...
    images.forEach((image)=>{
        const item = _carouselJs.createCarouselItem(image.url, image.breeds?.[0]?.name || "Cat", image.id);
...
async function loadBreedImages(breedId) {
    ...
    const breed = images[0]?.breeds?.[0] || breedsCache.get(breedId);
    renderBreedInfo(breed);
    renderCarouselImages(images);
    if (!images.length) infoDump.innerHTML += "<p><em>No images found for this breed.</em></p>";
}
/**
...
breedSelect.addEventListener("change", async (event)=>{
    try {
        await loadBreedImages(event.target.value);
    } catch (error) {
...
async function favourite(imgId) {
    try {
        const favouritesResponse = await (0, _axiosDefault.default).get("/favourites");
        const existingFavourite = favouritesResponse.data.find((item)=>item.image_id === imgId);
 ...
 */ async function getFavourites() {
    try {
        ...
        _carouselJs.clear();
        infoDump.innerHTML = `<h3>Favourite Cats</h3><p>Total favourites: ${favourites.length}</p>`;
...
},{"./Carousel.js":"iLxUV","axios":"kooH4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iLxUV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["ltI17","jOXmm"], "jOXmm", "parcelRequire6d5d", {})

//# sourceMappingURL=assignments.e02fbd41.js.map
